    ...
    for (var i = 0; i<productInfo.length; i++)
        {
            ...
            $("#partList").append("<li><a class=" + partButton +" id=" + i  + " >" +productInfo[i].ProductName+"<br> Quantity: "+productInfo[i].Quantity+"<br> Location: "+productInfo[i].Location+"</a></li>"); //#partList where to show list in html. productInfo[i] is database. productInfo is attribute
        }
